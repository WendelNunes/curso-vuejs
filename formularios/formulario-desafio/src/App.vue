    ...
    <div class="conteudo">
      <form class="painel" v-if="!enviado">
        ...
        <Rotulo nome="Armazenar Dados?">
          <span class="mr-4">
            <input type="radio" value="1" v-model="armazenarDados" />
            Sim
          </span>
          <span class="mr-4">
            <input type="radio" value="0" v-model="armazenarDados" />
            Não
          </span>
        </Rotulo>
        <hr />
      ...
      <div class="painel" v-else>
        ...
        <Rotulo nome="Armazenar Dados?">
          <span>{{ armazenarDados == "1" ? "Sim" : "Não" }}</span>
        </Rotulo>
      </div>
    </div>
  </div>
